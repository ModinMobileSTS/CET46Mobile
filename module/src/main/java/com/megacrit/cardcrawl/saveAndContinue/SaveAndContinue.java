...
public class SaveAndContinue {
    ...
    public static boolean saveExistsAndNotCorrupted(AbstractPlayer p) {
        ...
        if (fileExists) {
            try {
                ...
                deleteSave(p);
                logger.info(p.chosenClass.name() + " save INVALID!", new Object[0]);
                return false;
            }

            logger.info(p.chosenClass.name() + " save exists and is valid.", new Object[0]);
            return true;
        } else {
            logger.info(p.chosenClass.name() + " save does NOT exist!", new Object[0]);
            return false;
        }
    }
    ...
    public static SaveFile loadSaveFile(AbstractPlayer.PlayerClass c) {
        ...
        try {
            ...
            logger.info("Exception occurred while loading save!", new Object[0]);
            e.printStackTrace();
    ...
    private static SaveFile loadSaveFile(String filePath) throws SaveFileLoadError {
        ...
        try {
            ...
            if (!filePath.endsWith(".backUp")) {
                logger.info(filePath + " was corrupt, loading backup...", new Object[0]);
        ...
        if (saveFile == null) {
            ...
            logger.info(filePath + " save file was successfully loaded.", new Object[0]);
            return saveFile;
        }
    }
    ...
    public static void deleteSave(AbstractPlayer p) {
        ...
        logger.info("DELETING " + savePath + " SAVE", new Object[0]);
