...
public class SaveFile {
    ...
    public SaveFile(SaveType type) {
        ...
        for(Map.Entry<String, CustomSavableRaw> field : BaseMod.getSaveFields().entrySet()) {
            modSaves.put((String)field.getKey(), ((CustomSavableRaw)field.getValue()).onSaveRaw());
        }
        ...
        logger.info("Next Room: " + this.current_room, new Object[0]);
            ...
            case POST_COMBAT:
                ...
                for(RewardItem i : AbstractDungeon.getCurrRoom().rewards) {
                    switch (i.type) {
                        ...
                        case EMERALD_KEY:
                        case CARD:
                            this.combat_rewards.add(new RewardSave(i.type.toString(), (String)null));
                            break;
                        case GOLD:
                            this.combat_rewards.add(new RewardSave(i.type.toString(), (String)null, i.goldAmt, i.bonusGold));
                            break;
                        case POTION:
                        ...
                        case RELIC:
                            ...
                            break;
                        case STOLEN_GOLD:
                            this.combat_rewards.add(new RewardSave(i.type.toString(), (String)null, i.goldAmt, 0));
                    }
                }
            case POST_NEOW:
