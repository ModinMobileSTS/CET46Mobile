...
import cET46Initializer.actions.CorrectAction;
import cET46Initializer.actions.GeneralQuizAction;
import cET46Initializer.actions.QuizAction;
...
import cET46Initializer.powers.PerfectAnsPower;
import cET46Initializer.savedata.CorrectionNote;
...
public abstract class QuizRelic extends AbstractRelic  {
    protected static final SpireAndroidLogger logger = SpireAndroidLogger.getLogger(QuizRelic.class);
    ...
    public void triggerQuiz() {
        ...
        LexiconEnum usingLexicon = bookConfig.lexicons.get(0);
    ...
    public void onRightClick() {
        // 避免重复触发
        if (AbstractDungeon.screen == AbstractDungeon.CurrentScreen.WORD_SCREEN) {
            return;
        }
        // 这个只应该在战斗房间触发
